...
public static class SocketHelper
{
    ...
    private static async Task<bool> CheckIfMessageIsNullAsync(Socket handler, Message? message,
    ...
    private static async Task<bool> CheckIfMessageHaveSenderAsync(Socket handler, Message? message,
        MessageResponse response)
    {
    ...
    private static async Task<bool> CheckIfMessageHaveRecipientsAsync(Socket handler, Message? message,
        MessageResponse response)
    {
