...
{
    public static void StartReceivingMessagesAsync(
        this AsyncDuplexStreamingCall<TopicMessage, TopicMessageResponse>? call)
    {
        _ = Task.Run(async () =>
        {
    ...
    public static async Task StartSendingMessagesAsync(
        this AsyncDuplexStreamingCall<TopicMessage, TopicMessageResponse>? call)
    {
        while (true)
        {
